...
👉 **Authentication**: User authentication using Google/GitHub through Clerk, ensuring secure sign-in/out and session management.
...
```bash
git clone https://github.com/swamiabhishek45/live-docs.git
cd live-docs
```
...
- [Clerk Starter Guide](https://clerk.com/docs/quickstarts/nextjs)
